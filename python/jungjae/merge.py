...
df = pd.read_csv('d:/data/final/horse_total_all.csv')
...
df['chulno']=df['chulno'].astype('str')
filter = df['chulno'].str.contains('^[\d]+$')
df = df[filter]
...
df.to_csv('d:/data/final/horse_total_merged.csv',encoding='utf-8-sig')