...
function html5Upload() {
    ...
    sUploadURL = '/file_uploader_DEXT'; 	//upload URL
    //파일을 하나씩 보내고, 결과를 받음.
...
function callAjaxForHTML5(tempFile, sUploadURL) {
	console.log("callAjaxForHTML5=="+sUploadURL);
        ...
        onload: function (res) { // 요청이 완료되면 실행될 콜백 함수
            ...
            if (res.readyState() == 4) {
                if (sResString.indexOf("NOTALLOW_") > -1) {
                    ...
                    console.log("callback : " + res._response.responseText);
...
*/
function callFileUploader (){ // 싱글파일 업로드
